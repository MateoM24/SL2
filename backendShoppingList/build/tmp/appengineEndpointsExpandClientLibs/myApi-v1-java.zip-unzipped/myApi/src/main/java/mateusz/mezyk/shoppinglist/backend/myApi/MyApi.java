...
package mateusz.mezyk.shoppinglist.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<mateusz.mezyk.shoppinglist.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, mateusz.mezyk.shoppinglist.backend.myApi.model.MyBean.class);
